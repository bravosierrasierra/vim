...
syn keyword tclStatement	proc global return lindex puts regsub package require catch
syn keyword tclStatement	llength lappend lreplace lrange list concat incr exit
